...
2. Каждые несколько секунд проверяет новые сообщения
3. Обрабатывает команды `/start`, кнопки, текстовые сообщения
4. Отвечает пользователям актуальным расписанием
...
**Бот готов к работе сразу после деплоя!**

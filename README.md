...
- Если прошло четное количество недель с базовой даты - используется четная неделя
- Если прошло нечетное количество недель с базовой даты - используется нечетная неделя

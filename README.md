...
#### **ШАГ 1: Выполните команду настройки вебхука**
```bash
...
```
Увидите красивую страницу с инструкциями.

#### **ШАГ 3: Протестируйте бота**
- Отправьте `/start` боту в Telegram
- Должны увидеть кнопки меню
...
3. Проверьте, что команда вебхука выполнилась успешно

**Правильный URL:** `https://telegram-itmo-bot-.onrender.com/webhook`

**Без настройки вебхука бот не получит сообщения!**

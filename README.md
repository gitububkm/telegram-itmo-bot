...
Для более надежной работы бота на Render рекомендуется настроить вебхук:
...
3. Установите вебхук командой:
   ```
   https://api.telegram.org/botyour_bot_token_here/setWebhook?url=https://your-service-name.onrender.com
   ```

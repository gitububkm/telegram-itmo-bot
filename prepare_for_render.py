...
def main():
    ...
    print("\n📝 Следующие шаги:")
    print("1. Закоммитьте изменения: git add . && git commit -m 'Switch to polling mode - no webhooks needed'")
    ...
    print("5. После деплоя бот готов к работе - никаких дополнительных настроек!")
    print("6. Отправьте /start боту в Telegram - он ответит кнопками меню")
    print("7. Проверьте логи в Render Dashboard после деплоя")

...
def main():
    ...
    print("\n📝 Следующие шаги:")
    print("1. Закоммитьте изменения: git add . && git commit -m 'Fix event loop lifecycle for polling mode'")
    ...
    print("8. Бот должен работать без ошибок 'Event loop is closed'!")

...
def main():
    ...
    print("\n📝 Следующие шаги:")
    print("1. Закоммитьте изменения: git add . && git commit -m 'Fix async event loop management for polling mode'")
    ...
    print("6. В логах увидите 'Вебхук успешно удален' и 'Бот запущен в режиме polling'")
    print("7. Отправьте /start боту в Telegram - он ответит кнопками меню")
    print("8. Бот должен работать без ошибок Event loop!")

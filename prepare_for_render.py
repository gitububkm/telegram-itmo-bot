...
def main():
    ...
    print("\n📝 Следующие шаги:")
    print("1. Закоммитьте изменения: git add . && git commit -m 'Add persistent menu after each command execution'")
    ...
    print("8. После каждого действия бот показывает меню снова - не нужно заново писать /start!")

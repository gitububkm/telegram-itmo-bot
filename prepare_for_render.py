...
def main():
    ...
    print("\n📝 Следующие шаги:")
    print("1. Закоммитьте изменения: git add . && git commit -m 'Add automatic webhook deletion for polling mode'")
    ...
    print("5. После деплоя бот автоматически удалит вебхук и перейдет в режим polling")
    print("6. Отправьте /start боту в Telegram - он ответит кнопками меню")
    print("7. В логах увидите 'Вебхук успешно удален' и успешный запуск polling")
    print("8. Проверьте работу бота - он должен отвечать мгновенно!")

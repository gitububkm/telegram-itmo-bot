...
def main():
    ...
    print("\n📝 Следующие шаги:")
    print("1. Закоммитьте изменения: git add . && git commit -m 'Fix bot architecture: asyncio in main thread, web server in separate thread'")
    ...
    print("   ✅ Бот работает в главном потоке (asyncio)")
    print("   ✅ Веб-сервер в отдельном потоке (Flask/Werkzeug)")
